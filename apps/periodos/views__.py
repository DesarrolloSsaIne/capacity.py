        ...
        if form.is_valid():
            ...
            try:
               ...
               # EnviarCorreoAbrirPeriodoAnual()
                ...
                messages.success(self.request, "El Periodo Anual de Planificación ha sido abierto correctamente y se ha enviado un correo a las Jefaturas.!")
                return HttpResponseRedirect('/periodos/listar')


            except:
                request.session['message_class'] = "alert alert-success"
                messages.success(self.request, "El Periodo Anual de Planificación ha sido abierto correctamente, pero el servicio de correo tuvo un inconveniente favor comuníquese con las jefaturas para informar de la apertura.")
                return HttpResponseRedirect('/periodos/listar')
    ...
    try:
        ...
        if connection.is_connected():
            ...
            cursor.execute("""INSERT into periodos_respaldoperiodo(
                            ...
                            INNER JOIN productos_glo_productosestadisticos pes ON pes.id = ac.id_producto_estadistico_id
