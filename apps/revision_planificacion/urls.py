...
from apps.revision_planificacion.views import UnidadesListar, ObjetivosListar, ActividadesListar, RechazaPlan, AceptaPlan, GestionObservacionesActividades, GestionObservacionesObjetivosVp2,ActividadDetalle
